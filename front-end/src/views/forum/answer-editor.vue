        ...
        <el-card class="box-card">
          ...
          <el-card class="article-brief">
            <el-form :model="form" class="label-form" label-width="100px">
              ...
              <el-form-item label="回答简介" class="input-item">
                <el-input
                    type="textarea"
                    :rows="2"
                    placeholder="请输入回答简介，100字以内"
...
import QuestionCard from "../../components/faq/question-card.vue";
export default {
  data() {
    return {
      form: {
  ...
  methods:{
    ...
    publish(){
      ...
      axios.post('http://localhost:8080/question/add-answer',answer)
          .then(response=>{
