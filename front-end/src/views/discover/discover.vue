<template>
  <el-container direction="vertical" class="index-container" >
    ...
    <el-container class="main-container">
      ...
      <el-main>
        <Articles class="article-container"/>
      </el-main>
      <el-aside width="20%" >
        <CreationCenter />
      </el-aside>
...
import Articles from "../../components/article/article-list.vue"
...
export default {
  name: 'Index',
  components: {Navigation, Articles,Carousel,CategoryCard,HotList,CreationCenter,},
  data() {
    return {
